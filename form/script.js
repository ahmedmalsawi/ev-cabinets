...
var tafkeetInput = document.getElementById("input_6");
var tafkeetTax = document.getElementById("inputTax");
var tafkeetTotal = document.getElementById("inputTotal");
var tafkeetResult = document.getElementById("result");
...
function getPrice() {
	...
	if (fraction.length == 2) {
		...
		document.getElementById("result").value += " هللة  فقط لا غير";
		console.log("Done");
		...
		document.getElementById("result").value =" يمكنك استخدام رقمين فقط في الكسور";
		console.log("Done");
	}
}


document.getElementById("input_6").addEventListener("keyup", getPrice);
